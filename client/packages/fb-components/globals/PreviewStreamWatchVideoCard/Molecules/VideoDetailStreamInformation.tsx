...
const VideoDetailStreamInformation = (props: VideoDetailStreamInformationProps) => {
  ...
  <Wrapper m="15px 0">
    <FlexWrapper align="center">
      ...
      <Wrapper m="0 0 0 10px">
        <TextLabel block weight textColor="vgTextBlack">{title}</TextLabel>
        <Wrapper p="5px 0 0 0">
          <TextLabel weight textSize={200}>{detail}</TextLabel>
        </Wrapper>
      </Wrapper>
    </FlexWrapper>
  </Wrapper>
