...
const HelpHeaderNavigator = () => {
    const navigationOptionsState = helpStore.useStoreState(state => state.navigationOptions);
    return (
       <Header>
          <FlexWrapper align="center">
             ...
             <TextLabel weight textColor="vgTextBlack">Servicio de ayuda</TextLabel>
          </FlexWrapper>
          ...
          <FlexWrapper className="header__options">
             <Button variant="neutral" circle="medium"><BiSearch size={20}/></Button>
             <Button variant="neutral" circle="medium"><FaInbox size={20} /></Button>
