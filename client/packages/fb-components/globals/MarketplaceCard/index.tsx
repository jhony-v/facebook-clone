...
const MarketplaceCard = ({
  onClick, image, price, description, location,
  ...
  return (
    <MarketplaceCardWrapper onClick={onClick}>
      <SquareImage data-src={image} ref={setElement} {...!!processImage && { src: processImage }} />
      <Wrapper>
        <Wrapper p="10px 0 5px">
          <TextLabel weight textColor="vgTextBlack">{price}</TextLabel>
        </Wrapper>
        <Wrapper p="5px 0">
          <TextLabel textSize={400} textColor="vgTextBlack">{description}</TextLabel>
        </Wrapper>
        <Wrapper p="5px 0">
