...
export const FormOptionsSignIn : React.FC = ({ children }) => {
    ...
    <>
      <Wrapper m="30px 0">
        <FlexWrapper flexDirection="column" align="center">
          ...
          <Wrapper p="20px 0">
            <TextLabel textSize={200} textColor="vgTextBlack">Do not have an account?</TextLabel>
            <Wrapper p="0 5px" inlineBlock>
              <TextLabel textSize={200} textColor="vgTextPrimary" onClick={() => onToggle()}>Click herre to sign up.</TextLabel>
            </Wrapper>
          </Wrapper>
        </FlexWrapper>
      </Wrapper>
