  ...
  return (
    <Wrapper className="profile__pagelet">
      <FlexWrapper justify="space-between" align="center">
        <Wrapper w="60%">
          <TabOptions onSelectedOption={(e) => {}} initialId="a" style={{
              boxShadow : "none",
          }}>
            <>
        ...
        <FlexWrapper>
                <RaisedButtonMoreOptions> <FaFacebookMessenger style={{marginRight:"5px"}}/> Message</RaisedButtonMoreOptions>
                <RaisedButtonMoreOptions> <FaPhone/></RaisedButtonMoreOptions>
                <RaisedButtonMoreOptions> <FaUser/></RaisedButtonMoreOptions>
                <RaisedButtonMoreOptions> <FiMoreHorizontal/></RaisedButtonMoreOptions>
        </FlexWrapper>
      </FlexWrapper>
    </Wrapper>
  );
